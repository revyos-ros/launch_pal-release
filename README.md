...
## launch_pal (humble) - 0.5.0-1

The packages in the `launch_pal` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble launch_pal --override-release-repository-push-url git@github.com:revyos-ros/launch_pal-release.git` on `Mon, 23 Sep 2024 14:27:17 -0000`
